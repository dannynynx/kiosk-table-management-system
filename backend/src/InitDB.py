...
def initialise_db(DB_PATH):
    """
    Initialise the database with the necessary tables.
    ...
    items = [
        ...
        ('Chicken Tacos', 'Small hand-sized corn-based tortilla topped with chicken, avocado, onion, and tomato', 2,
         13.99, 'Chicken_Tacos.png', 15),
        ('Spanish Paella', 'Saffron infused rice with chicken, chorizo, prawns, and mussels', 2, 14.99,
         'Spanish_Paella.png', 16),
        ...
        ('Chicken Caesar Salad',
         'Romaine lettuce and croutons dressed with parmesan cheese, chicken, and Caesar dressing', 2, 12.99,
         'Chicken_Caesar_Salad.png', 19),
        ('Salmon Avocado Sushi Roll', 'Sushi roll with salmon, avocado, and cucumber', 2, 13.99,
         'Salmon_Avocado_Sushi_Roll.png', 20),
        ('Carbonara', 'Classic Italian pasta dish with eggs, hard cheese, pancetta, and pepper', 3, 15.99,
         'Carbonara.png', 21),
        ('Beef Wellington', 'Tender beef fillet wrapped in puff pastry with mushroom duxelle', 3, 29.99,
         'Beef_Wellington.png', 22),
        ('Roast Lamb Leg', 'Slow-roasted lamb leg with rosemary and garlic', 3, 25.99, 'Roast_Lamb_Leg.png', 23),
        ('Turducken', 'A deboned chicken stuffed into a deboned duck, further stuffed into a deboned turkey', 3, 34.99,
         'Turducken.png', 24),
        ...
        ('Tiramisu',
         'Coffee-flavoured Italian dessert made of lady fingers dipped in coffee, layered with a whipped mixture of eggs, sugar, and mascarpone cheese, flavoured with cocoa',
         4, 7.99, 'Tiramisu.png', 27),
        ('Creme Brulee', 'Rich custard base topped with a layer of hardened caramelised sugar', 4, 6.99,
         'Creme_Brulee.png', 28),
        ('Japanese Cheese Cake', 'Light and fluffy cheesecake with a smooth, creamy texture', 4, 8.99,
         'Japanese_Cheese_Cake.png', 29)
    ]
    cursor.executemany(
        "INSERT OR IGNORE INTO ITEMS (name, description, category_id, cost, image, position) VALUES (?, ?, ?, ?, ?, ?)",
        items)
    ...
    cursor.executemany("INSERT OR IGNORE INTO ITEM_INGREDIENTS (item_id, ingredient_id) VALUES (?, ?)",
                       item_ingredients)
    ...
    cursor.executemany("INSERT INTO STAFF (username, password, role, in_use, logout_code) VALUES (?, ?, ?, ?, ?)",
                       staff_logins)
    ...
    cursor.executemany("INSERT INTO CUSTOMISATION (logo_image, primary_hex_code, secondary_hex_code) VALUES (?, ?, ?)",
                       customisation_settings)
